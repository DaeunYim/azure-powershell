...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.mysql/get-azmysqlflexibleserverconnect
#>
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.MySql.custom\Get-AzMySqlFlexibleServerConnect';
            GetViaIdentity = 'Az.MySql.custom\Get-AzMySqlFlexibleServerConnect';
        }
