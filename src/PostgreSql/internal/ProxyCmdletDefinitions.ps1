...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.postgresql/get-azpostgresqlflexibleservervirtualnetworksubnetusage
#>
...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.postgresql/get-azpostgresqllocationbasedperformancetier
#>
...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20200214Preview.IOperationListResultAutoGenerated
.Link
https://docs.microsoft.com/en-us/powershell/module/az.postgresql/get-azpostgresqloperation
#>
function Get-AzPostgreSqlOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20171201.IOperation], [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20200214Preview.IOperationListResultAutoGenerated])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter()]
    [Alias('AzureRMContext', 'AzureCredential')]
...
INPUTOBJECT <IPostgreSqlIdentity>: Identity Parameter
  ...
  [VirtualNetworkRuleName <String>]: The name of the virtual network rule.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.postgresql/get-azpostgresqlserveradministrator
#>
...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.postgresql/new-azpostgresqlconfiguration
#>
...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.postgresql/new-azpostgresqlserversecurityalertpolicy
#>
...
INPUTOBJECT <IPostgreSqlIdentity>: Identity Parameter
  ...
  [VirtualNetworkRuleName <String>]: The name of the virtual network rule.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.postgresql/remove-azpostgresqlserveradministrator
#>
...
PARAMETER <IDatabase>: Represents a Database.
  ...
  [Collation <String>]: The collation of the database.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.postgresql/set-azpostgresqldatabase
#>
...
PARAMETER <IServerSecurityAlertPolicy>: A server security alert policy.
  ...
  [StorageEndpoint <String>]: Specifies the blob storage endpoint (e.g. https://MyAccount.blob.core.windows.net). This blob storage will hold all Threat Detection audit logs.
.Link
https://docs.microsoft.com/en-us/powershell/module/az.postgresql/set-azpostgresqlserversecurityalertpolicy
#>
...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.postgresql/test-azpostgresqlnameavailability
#>
function Test-AzPostgreSqlNameAvailability {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20171201.INameAvailability], [Microsoft.Azure.PowerShell.Cmdlets.PostgreSql.Models.Api20200214Preview.INameAvailabilityAutoGenerated])]
